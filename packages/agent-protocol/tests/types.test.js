 ...
 */
import { MessageType, isAgentMessage, isServerToAgentMessage, isDashboardMessage, isServerToDashboardMessage, } from '../src/types.js';
describe('Type System Tests', () => {
    describe('Enum Values', () => {
        ...
        describe('AgentType', () => {
            it('should have expected agent types', () => {
                const expectedTypes = ['CLAUDE', 'GEMINI', 'CODEX'];
        ...
        describe('AgentStatus', () => {
            it('should have expected agent statuses', () => {
                const expectedStatuses = ['ONLINE', 'OFFLINE', 'CONNECTING', 'ERROR'];
        ...
        describe('AgentActivityState', () => {
            it('should have expected activity states', () => {
                const expectedStates = ['IDLE', 'PROCESSING', 'QUEUED'];
        ...
        describe('CommandType', () => {
            it('should have expected command types', () => {
                const expectedTypes = ['NATURAL', 'INVESTIGATE', 'REVIEW', 'PLAN', 'SYNTHESIZE'];
                expectedTypes.forEach(type => {
                    expect(type).toBeDefined();
                    expect(typeof type).toBe('string');
                });
        ...
        describe('CommandStatus', () => {
            it('should have expected command statuses', () => {
                const expectedStatuses = ['PENDING', 'QUEUED', 'EXECUTING', 'COMPLETED', 'FAILED', 'CANCELLED'];
                expectedStatuses.forEach(status => {
                    expect(status).toBeDefined();
                    expect(typeof status).toBe('string');
                });
        ...
        describe('StreamType', () => {
            it('should have expected stream types', () => {
                const expectedTypes = ['STDOUT', 'STDERR'];
                expectedTypes.forEach(type => {
                    expect(type).toBeDefined();
                    expect(typeof type).toBe('string');
                });
        ...
        describe('TraceType', () => {
            it('should have expected trace types', () => {
                const expectedTypes = ['LLM_PROMPT', 'TOOL_CALL', 'RESPONSE'];
                expectedTypes.forEach(type => {
                    expect(type).toBeDefined();
                    expect(typeof type).toBe('string');
                });
        ...
        describe('ErrorType', () => {
            it('should have expected error types', () => {
                const expectedTypes = ['CONNECTION', 'EXECUTION', 'RESOURCE', 'UNKNOWN'];
                expectedTypes.forEach(type => {
                    expect(type).toBeDefined();
                    expect(typeof type).toBe('string');
                });
        ...
        describe('AgentControlAction', () => {
            it('should have expected control actions', () => {
                const expectedActions = ['STOP', 'RESTART', 'PAUSE', 'RESUME'];
        ...
        describe('ReportStatus', () => {
            it('should have expected report statuses', () => {
                const expectedStatuses = ['DRAFT', 'IN_PROGRESS', 'COMPLETE'];
                expectedStatuses.forEach(status => {
                    expect(status).toBeDefined();
                    expect(typeof status).toBe('string');
                });
    ...
    describe('Type Consistency', () => {
        it('should have consistent enum and union type values', () => {
            ...
            const commandTypes = ['NATURAL', 'INVESTIGATE', 'REVIEW', 'PLAN', 'SYNTHESIZE'];
        ...
        it('should have all message types accounted for in type guards', () => {
            ...
            allMessageTypes.forEach(type => {
                ...
                if (isServerToAgentMessage(type))
                    categorizedTypes.add(type);
                if (isDashboardMessage(type))
                    categorizedTypes.add(type);
                if (isServerToDashboardMessage(type))
                    categorizedTypes.add(type);
            });
    ...
    describe('Type Safety', () => {
        it('should prevent invalid assignments at compile time', () => {
            ...
            const validAgentType = 'CLAUDE';
            const validStatus = 'ONLINE';
            const validCommandType = 'NATURAL';
